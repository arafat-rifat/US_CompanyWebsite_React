      ...
      <Hero>
        <Container>
          ...
          <div className="flex flex-col gap-[25px] pt-[200px] laptop:pt-[300px] pb-[20px] laptop:pb-[100px] px-[20px] desktop:px-0">
            ...
            <h5 className="text-[#FFFFFF] font-thin leading-[32px] laptop:leading-[56px] text-[32px]  laptop:text-[48px] max-w-[961px]">
              We make custom software, design great websites, and offer IT help.
